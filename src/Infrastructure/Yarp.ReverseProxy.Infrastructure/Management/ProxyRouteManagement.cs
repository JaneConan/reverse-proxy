...
public class ProxyRouteManagement : IProxyRouteManagement
{
    ...
    private ReverseProxyDbContext DbContext;
    private readonly IReverseProxy _reverseProxyStore;

    public ProxyRouteManagement(ReverseProxyDbContext dbContext, IReverseProxy reverseProxyStore, ILogger<ProxyRouteManagement> logger)
    {
        DbContext = dbContext;
