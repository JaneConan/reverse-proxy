...
{
    public class InConfigProvider : IProxyConfigProvider, IDisposable
    {
        private readonly object _lockObject = new object();
        private readonly ILogger<InConfigProvider> _logger;
        private readonly IReverseProxy _strore;
        private ProxyConfig _config;
        private CancellationTokenSource _changeToken;
        private bool _disposed;
        private IDisposable _subscription;

        public InConfigProvider(ILogger<InConfigProvider> logger, IReverseProxy strore)
        {
        ...
        private void UpdateConfig()
        {
            ...
            lock (_lockObject)
            {
                ...
                ProxyConfig newConfig = null;
                try
                {
                    newConfig = _strore.GetConfig() as ProxyConfig;
                }
                catch (Exception ex)
                {
